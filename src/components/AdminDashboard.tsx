                    ...
                    >
                      ...
                      <div className="space-y-3 overflow-y-auto max-h-96">
                        {submissions.slice(0, 5).map((submission) => (
                          <div key={submission.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 rounded-xl border space-y-3 sm:space-y-0" style={{ borderColor: theme.cardBorder }}>
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="min-w-0 flex-1">
                                <p className="typography-small sm:typography-ui font-semibold truncate" style={{ color: theme.textPrimary }}>{submission.name}</p>
                                <p className="typography-small" style={{ color: theme.textSecondary }}>${submission.purchase_amount.toFixed(2)}</p>
                              </div>
                            </div>
                            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                              <span 
                                className="px-2 sm:px-3 py-1 rounded-full typography-small font-semibold border flex items-center"
                              ...
                              {submission.status === 'pending' && (
                                <div className="flex space-x-2">
                                  <button
                                    ...
                                    className="px-2 sm:px-3 py-1 rounded-lg typography-small font-semibold transition-colors"
                                  ...
                                  <button
                                    ...
                                    className="px-2 sm:px-3 py-1 rounded-lg typography-small font-semibold transition-colors bg-red-500 text-white"
                                  >
                                    Reject
                                  </button>
                                </div>
