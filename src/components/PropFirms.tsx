    ...
    >
      ...
      {firm.is_first_time_offer && (
        ...
        >
          ...
          <span className="hidden sm:inline">First-Time Offer</span>
      ...
      <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6 mb-6 sm:mb-8">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="typography-small sm:typography-body leading-relaxed" style={{ color: theme.textSecondary }}>{firm.description}</p>
        </div>
      </div>

      <div 
        className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8 p-4 sm:p-6 rounded-2xl border"
        style={{
      ...
      >
        <div className="text-center">
          <div className="text-2xl sm:text-3xl font-bold mb-1" style={{ color: theme.accent }}>
            {firm.discount_percentage}%
          </div>
          <div className="typography-small font-semibold" style={{ color: theme.textSecondary }}>Discount</div>
        </div>
        <div className="text-center">
          <div className="text-2xl sm:text-3xl font-bold mb-1" style={{ color: theme.accent }}>
          ...
          {showFirstTimeOnly && (
            ...
            >
              <p className="typography-small font-semibold" style={{ color: theme.accent }}>
                ✨ Showing firms with special first-time customer offers
              </p>
            </div>
          )}
        </div>
        ...
        {filteredFirms.length === 0 && (
          ...
          >
            ...
            <h3 className="typography-h4 mb-3 sm:mb-4" style={{ color: theme.textPrimary }}>
              No First-Time Offers Available
            </h3>
            <p className="typography-body mb-4 sm:mb-6 px-4" style={{ color: theme.textSecondary }}>
              There are currently no prop firms offering first-time customer discounts. 
              Toggle off the filter to see all available firms.
            </p>
            <button
              onClick={() => setShowFirstTimeOnly(false)}
