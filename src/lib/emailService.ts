// Email service utilities for PropCashback
...
export const emailTemplates = {
  welcome: (userName: string): EmailTemplate => ({
    subject: 'Welcome to PropCashback!',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h1 style="color: #8B5A9F;">Welcome to PropCashback, ${userName}!</h1>
        ...
        <p>Happy trading!</p>
        <p>The PropCashback Team</p>
      </div>
    `,
    text: `Welcome to PropCashback, ${userName}! Thank you for joining our community of smart traders who save money on prop firm challenges. Browse our featured prop firms, purchase challenges through our affiliate links, submit your cashback requests, and get paid in crypto! If you have any questions, feel free to reach out to our support team. Happy trading! The PropCashback Team`
  }),

  statusChange: (userName: string, status: string, amount: number, firmName: string): EmailTemplate => ({
    subject: `Cashback Request ${status.charAt(0).toUpperCase() + status.slice(1)} - PropCashback`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Best regards,<br>The PropCashback Team</p>
      </div>
    `,
    text: `Hi ${userName}, Your cashback request for ${firmName} has been ${status}. ${status === 'paid' ? `Amount: $${amount.toFixed(2)}. Your cashback has been sent to your crypto wallet.` : status === 'rejected' ? 'Unfortunately, we couldn\'t process your cashback request. Please contact support if you believe this was an error.' : ''} You can view all your requests in your dashboard. Best regards, The PropCashback Team`
  }),

  confirmation: (userName: string, firmName: string, amount: number): EmailTemplate => ({
    subject: 'Cashback Request Received - PropCashback',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Thank you for using PropCashback!</p>
        <p>The PropCashback Team</p>
      </div>
    `,
    text: `Hi ${userName}, We've received your cashback request for ${firmName}. Purchase Amount: $${amount.toFixed(2)}. Status: Under Review. We'll review your request and process it within 5-7 business days. You'll receive an email notification once the status changes. Thank you for using PropCashback! The PropCashback Team`
  })
}
